...
static GtkWidget *
app_launcher_new_from_app_info (MaynardLauncher *self,
    ShellAppInfo *info)
{
  GIcon *icon;
  ...
  /* app name */
  label = gtk_label_new (shell_app_info_get_display_name (info));
  ...
  for (l = values; l; l = l->next)
    {
      ...
      GtkWidget *app = app_launcher_new_from_app_info (self, info);
